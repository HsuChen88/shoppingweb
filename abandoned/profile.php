			    ...
			    <div id="main-wrapper">
							<v-table class="datatable" style="border: 1px black;">
								...
								<v-row>
                                    ...
                                    <?php echo "<v-col cols='5' sm='6' style='padding: 20px; font-size: 150%'>".$user_name."</v-col>"; ?>
								</v-row>
								<v-row>
									<v-col cols='5' sm='3' style='padding: 20px; font-size: 150%'>會員電話</v-col>
                                    <?php echo "<v-col cols='5' sm='6' style='padding: 20px; font-size: 150%'>".$user_phone."</v-col>"; ?>
								</v-row>
							</v-table>
				</div>
			</div>
